...
var Box = _get__("styled")(_get__("RebassBox"))(_templateObject(), function (p) {
  return p.showLayout ? 'rgba(133, 233, 133, 0.65)' : 'init';
});

var Footer = function Footer(props) {
  var _get__2 = _get__("useContext")(_get__("appContext")),
      showLayout = _get__2.showLayout,
      toggleShowLayout = _get__2.toggleShowLayout;

  return _get__("React").createElement(_get__("Box"), {
    showLayout: showLayout
  }, _get__("React").createElement("h1", null, "Build with Show me the video"));
};

var _default = _get__("Footer");
...
var _typeOfOriginalExport = _typeof(Footer);
